...
- **Агенты** - *описание агентов в системе NIKA*
    ...
    - [Агент классификации темы сообщения с помощью Rasa](agents/rasaMessageTopicClassificationAgent.md) - *определяет тему сообщений пользователя при помощи Rasa*

...
class AddEventAgent(ScAgentClassic):
    ...
    def run(self, action_node: ScAddr) -> ScResult:
        ...
        try:
            ...
            if not check_connector(
                ...
                self.logger.info("The message isn’t about adding calendar event")
                return ScResult.OK
            ...
            if not rrel_event_summary.is_valid() or not rrel_start_time.is_valid():
            ...
            params = self.get_event_params(
                message_addr, rrel_event_summary, rrel_start_time, rrel_end_time
            )
            ...
            response = self.add_event_in_calendar(
                headers, params["summary"], params["start_time"], params["end_time"]
            )
            if not response:
    ...
    def get_event_params(
        ...
        params = {"summary": summary, "start_time": start_time}

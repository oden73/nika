...
class Event(EventBase):
    ...
    def __str__(self):
        return (
            f"Event<summary={self.summary}, "
            f"start_time={self.start.dateTime}, "
            f"end_time={self.end.dateTime if self.end else None}>"
            )
...
class UpdateEvent(EventBase):
    ...
    def __str__(self):
        return (
            f"Event<summary={self.summary}, "
            f"start_time={self.start.dateTime if self.start else None}, "
            f"end_time={self.end.dateTime if self.end else None}>"
            )
